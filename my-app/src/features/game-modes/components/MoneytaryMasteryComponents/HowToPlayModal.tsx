        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fadeIn">
            ...
            >
                ...
                <div className="text-center mb-5 md:mb-8">
                    ...
                    <p className="text-white/60 text-sm md:text-lg">Master your financial knowledge!</p>
                </div>
                ...
                <div className="space-y-4 md:space-y-8">
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 md:space-y-3 text-white/70">
                                    <li className="flex items-start gap-2">
                                        ...
                                        <span className="text-xs md:text-base">Read the question on the flashcard.</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="text-blue-400 font-bold text-xs md:text-base">2.</span>
                                        <span className="text-xs md:text-base"><strong>Click the card</strong> to flip and reveal the answer.</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="text-blue-400 font-bold text-xs md:text-base">3.</span>
                                        <span className="text-xs md:text-base">Rate yourself using the buttons below.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="bg-white/5 rounded-xl p-4 md:p-6 border border-white/5 hover:bg-white/10 transition-colors">
                        <div className="flex items-start gap-3 md:gap-4">
                            ...
                            <div>
                                <h3 className="text-base md:text-xl font-bold text-white mb-1">Buttons & Rewards</h3>
                                <div className="space-y-2 text-white/70 text-[10px] md:text-sm">
                                    <p>The <strong>"Didnt Know"</strong> and <strong>"Knew It!"</strong> buttons are locked initially. <strong>Flip the card first</strong> to reveal the answer before you can rate yourself.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4 pt-3 border-t border-white/5">
                            <div className="bg-black/20 rounded-lg p-3 md:p-5 hover:bg-black/30 transition-colors">
                                ...
                                <p className="text-white/70 text-[10px] md:text-sm leading-relaxed">
                                    Earn XP for <strong className="text-white">"Knew It!"</strong> to level up.
                                </p>
                            </div>
                            <div className="bg-black/20 rounded-lg p-3 md:p-5 hover:bg-black/30 transition-colors">
