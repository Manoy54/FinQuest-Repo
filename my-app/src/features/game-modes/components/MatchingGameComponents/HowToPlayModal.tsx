        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fadeIn">
            ...
            >
                ...
                <div className="text-center mb-5 md:mb-8">
                    ...
                    <p className="text-white/60 text-sm md:text-lg">Connect the Pairs!</p>
                </div>
                ...
                <div className="space-y-4 md:space-y-8">
                    ...
                    <div className="bg-black/20 rounded-xl p-4 md:p-6 border border-white/5 hover:bg-black/30 transition-colors">
                        <div className="flex items-start gap-3 md:gap-4">
                            <div className="w-9 h-9 md:w-12 md:h-12 rounded-full bg-emerald-500/20 flex items-center justify-center text-lg md:text-2xl shrink-0">
                                🎯
                            </div>
                            <div>
                    ...
                    <div className="bg-black/20 rounded-xl p-4 md:p-6 border border-white/5 hover:bg-black/30 transition-colors">
                        <div className="flex items-start gap-3 md:gap-4">
                            ...
                            <div>
                                <h3 className="text-base md:text-xl font-bold text-white mb-1">Match Up</h3>
                                <p className="text-white/70 text-xs md:text-base leading-relaxed">
                ...
                <div className="mt-6 md:mt-8">
                    <button
                        onClick={onClose}
                        className="w-full py-3 md:py-4 rounded-xl md:rounded-2xl font-bold text-base md:text-lg text-white bg-gradient-to-r from-emerald-600 to-cyan-600 hover:from-emerald-500 hover:to-cyan-500 shadow-lg hover:shadow-emerald-500/25 transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-300"
                    >
                        Start Matching! 🚀
                    </button>
                </div>
