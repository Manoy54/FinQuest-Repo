        ...
        <div className="min-h-screen w-full flex items-center justify-center py-8 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-900 via-zinc-900 to-black relative overflow-hidden font-['Rajdhani']">
            ...
            <div className="relative z-10 w-full max-w-md p-6 bg-black/40 backdrop-blur-2xl border border-white/5 rounded-2xl shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] animate-fade-in-up">
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-400 hover:to-cyan-400 text-white font-bold text-lg py-3 px-4 rounded-xl shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_30px_rgba(16,185,129,0.5)] transform transition-all duration-300 mt-4 tracking-wider uppercase"
                    >
                        Create Account
                    </button>
                </form>
            ...
            {showSuccess && (
                <div className="absolute inset-0 z-50 flex items-center justify-center bg-zinc-900/80 backdrop-blur-sm animate-fade-in">
                    <div className="bg-zinc-800/90 border border-white/10 p-10 rounded-2xl shadow-2xl max-w-md w-full text-center relative overflow-hidden transform animate-bounce-in">
                        ...
                        <Link
                            to="/login"
                            className="inline-block w-full bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 !text-white font-black text-2xl tracking-widest py-4 px-6 rounded-xl shadow-lg hover:shadow-emerald-500/20 transform transition-all duration-200 uppercase"
                        >
                            SIGN IN
                        </Link>
                    </div>
