...
export function About() {
    ...
    const { ref: visionRefNode, isVisible: isVisionVisible } = useScrollAnimation(0.2);
    const { ref: missionRefNode, isVisible: isMissionVisible } = useScrollAnimation(0.2);
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div
                        ...
                        style={{
                            ...
                            transform: isVisionVisible ? 'translateY(0)' : 'translateY(50px)',
                            transitionDelay: '0ms',
                        }}
                    >
                    ...
                    <div
                        ...
                        style={{
                            ...
                            transform: isMissionVisible ? 'translateY(0)' : 'translateY(50px)',
