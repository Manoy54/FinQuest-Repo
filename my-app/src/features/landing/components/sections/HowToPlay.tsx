                ...
                <div className="relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
                        {steps.map((step, index) => (
                            ...
                            >
                                <div className="w-20 h-20 rounded-2xl bg-[#005cbf]/20 border border-white/10 backdrop-blur-sm flex items-center justify-center text-3xl mb-8 relative transition-transform duration-300 shadow-xl group-hover:shadow-blue-500/20 text-blue-400">
                                    {step.icon}
