...
export function Goals() {
    ...
    const { ref: goalsRefNode, isVisible: areGoalsVisible } = useScrollAnimation(0.2);
        ...
        <section className="py-24 px-4 text-white relative">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div
                    ...
                    style={{
                        opacity: areGoalsVisible ? 1 : 0,
                        transform: areGoalsVisible ? 'translateY(0)' : 'translateY(20px)',
