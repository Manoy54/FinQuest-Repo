                        ...
                        <div className="flex flex-col md:flex-row gap-6">
                            <div className="flex md:flex-col gap-2 overflow-x-auto pb-2 md:pb-0 scrollbar-hide">
                                {[
                                    ...
                                    <button key={tab.id} onClick={() => setActiveTab(tab.id as 'base' | 'face' | 'hair' | 'eyes' | 'mouth' | 'clothes' | 'bg')} className={`p-3 rounded-xl flex items-center gap-3 transition-all min-w-[100px] md:min-w-[140px] ${activeTab === tab.id ? 'bg-blue-500 text-white shadow-lg shadow-blue-500/20' : 'bg-white/5 text-white/50 hover:bg-white/10 hover:text-white'}`}>
